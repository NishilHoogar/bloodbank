...
<div class="container-fluid">
    <form action="" id="manage-handover">
        ...
        <div class="form-group">
            <label for="" class="control-label">Request Reference Code</label>
        ...
        <div class="form-group" style="display: none">
           ...
           <!-- <label for="" class="control-label">Receipent's Pic: </label>-->
           <!-- <input type="file" class="form-action" name="picture"  value="/*-->
        </div>
</div>
    </form>
</div>
