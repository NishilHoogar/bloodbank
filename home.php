...
<div class="containe-fluid">
	<div class="row mt-3 ml-3 mr-3">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <?php echo "Welcome Dr.". $_SESSION['login_name']."!"  ?>
                    <hr>
                    <h4><b>Inventory(In L)</b></h4>
                    <div class="row">
                        <?php 
                            ...
                            <div class="card">
                                <div class="card-body bg-light">
                                    <div class="card-body text-dark">
                                        <span class="float-right summary_icon"> <?php echo $v ?> <i class="fa fa-tint"></i></span>
                                        <h4><b>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body bg-light">
                                    <div class="card-body text-dark">
                                        <span class="float-right summary_icon"><i class="fa fa-users" aria-hidden="true"></i></span>
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM donors")->num_rows ?>
                                        </b></h4>
                                        <p><b>Total Registered Donors</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body bg-light">
                                    <div class="card-body text-dark">
                                        <span class="float-right summary_icon"> <i class="fa fa-check" aria-hidden="true"></i></span>
                                        <h4><b>
